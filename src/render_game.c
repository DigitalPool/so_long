...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/21 11:25:16 by ashobajo          #+#    #+#             */
/*   Updated: 2024/09/21 12:35:33 by ashobajo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	base->mlx = mlx_init();
// 	base->mlx_win = mlx_new_window(base->mlx, base->game->width * 40, base->game->height *40, "So_Long!");
// 	base->mlx_img = mlx_new_image(base->mlx, base->game->width * 40, base->game->height *40);
